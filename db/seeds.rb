...
user1 = User.create(first_name: "Erica", last_name: "Rojo", email: "ericarojo@gmail.com", password: "Pepe2020!", password_confirmation: "Pepe2020!")

user2 = User.create(first_name: "Natalie", last_name: "Barba", email: "nataliebarba@gmail.com", password: "Levisnoop!", password_confirmation: "Levisnoop!")

user3 = User.create(first_name: "Nicole", last_name: "Materosian", email: "nicolematerosian@gmail.com", password: "Piglet16", password_confirmation: "Pepe2020!")

user4 = User.create(first_name: "Gabe", last_name: "Rodriguez", email: "gaberodriguez@gmail.com", password: "videogames123", password_confirmation: "videogames123")
